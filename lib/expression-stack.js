...
function popWhenReady(priv, maybeOnBeforePop) {
  ...
  nodsl.check(typeof onBeforePop === 'function',
      'maybeOnBeforePop must be a function; got ', onBeforePop);
