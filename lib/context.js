...
//    console.log('');
  ...
  function createContext(context, proto) {
    Object.setPrototypeOf(context, proto);
  ...
  function createExtendedContext(context) {
    ...
    bindMethods(extended,
        [ _newContext, _push, _pop, _forcePop, _popWhenReady, _reset, _resetOrFail ], priv);
...
function _newContext(priv, value, name) {
