...
function ContextFactory(assertionRegistry, operatorRegistry) {
  ...
  var pub = Object.create(ContextFactory.prototype);
  bindMethods(pub, [ newContext ], priv);
  bindEvents(pub, priv.events);
  return pub;
}

function newContext(priv, value, name) {
