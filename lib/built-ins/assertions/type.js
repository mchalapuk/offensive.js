...
module.exports = {
  'ofType': new ParameterizedAssertion(function(context, requiredType) {
    ...
    return function hasProperType() {
      return typeof context._value === requiredType;
    };
  }),
  ...
  'anInteger': new Assertion(function(context) {
    this.message.appendText('an integer');

    return function isAnInteger() {
      return Number.isInteger(context._value);
    };
  }),
  'Integer': new Alias('anInteger'),
  'integer': new Alias('anInteger'),
  'anInt': new Alias('anInteger'),
  'Int': new Alias('anInteger'),
  'int': new Alias('anInteger'),
